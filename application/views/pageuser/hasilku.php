      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= site_url('ujian/hasil/'.$this->session->userdata('username').'') ?>"><i class="fa fa-circle-o"></i>Jurusan Kuliah</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url('ujian/hasil/'.$this->session->userdata('username')) ?>">Hasil Tes</a></li>
          ...
          <div class="col-md-2">
            ...
            <div class="col-md-8 w3-responsive">
              <div class="box box-solid w3-responsive" id="page">
                <div class="box-header with-border"><i class="fa fa-fw fa-graduation-cap"></i>Pemilihan Jurusan Kuliah
                </div>
                <div class="box-body" id="konten">
                  <div class="table-responsive no-border">
                    <a href="<?php echo site_url('ujian/myUjian/'.$id.'/print')?>" class="pull-right" target=_blank title="Cetak"><i class="fa fa-print fa-2x fa-border w3-text-grey"></i></a>
