...
<head>
  ...
  <title>PsikoPower | Peserta Tes</title>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?= site_url('quiz')?>"><i class="fa fa-drivers-license-o fa-fw"></i> Indikator
                <li class="active"><a href="#"><i class="fa fa-group fa-fw"></i> Peserta Tes</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
                ...
                <tbody>
                  <?php if ($peserta): ?>
                    ...
                    <tr class="">
                      ...
                      <td><?php if ($tampil->ujian=="tumbuh-balita.html") {
                      echo 'Tumbuh Balita';
                      } ?></td>
