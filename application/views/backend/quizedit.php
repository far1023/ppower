        ...
        <div class="row">
          ...
          <?php endif ?>
            ...
            <div class="col-md-7">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title"><a href="javascript:history.go(-1)" class="text-black form-head"><i class="fa fa-xs fa-angle-left fa-fw"> &nbsp</i>Edit Indikator</a></h3>
                ...
                <div class="box-body">
                  <div class="table-responsive">
                    <p>
                      ...
                      <textarea class="form-control" name="soal" required style="resize: vertical;"><?= $editsoal?></textarea>
                    </p>
                    <p>
                    ...
                    <p><div class="input-group">
                      ...
                      <input type="text" class="form-control" name="opsa" autocomplete="off" required title="opsA" value="<?= $edita ?>">
                    </div></p>
                    <p><div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-circle"></i>
                      ...
                      <input type="text" class="form-control" name="opsb" autocomplete="off" required title="opsB" value="<?= $editb ?>">
                    </div></p>
                    <p><div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-circle"></i>
                      ...
                      <input type="text" class="form-control" name="opsc" autocomplete="off" required title="opsC" value="<?= $editc ?>">
                    </div></p>
                    <p><div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-circle"></i>
                      ...
                      <input type="text" class="form-control" name="opsd" autocomplete="off" required title="opsD" value="<?= $editd ?>">
                    </div></p>
                    <p><div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-circle"></i>
                      ...
                      <input type="text" class="form-control" name="opse" autocomplete="off" required title="opsE" value="<?= $edite ?>">
                    </div></p>
                    <!-- /.mail-box-messages -->
                  </div>
                  <!-- /.box-body -->
