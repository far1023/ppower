...
<head>
  ...
  <title>PsikoPower | Icon Sets</title>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <?php foreach ($col as $show): ?>
            <li class="header"><?= $show->kategori ?></li>
            <?php foreach ($menu as $value): ?>
              <?php if ($value->kategori == $show->id && $value->aktif==1): ?>
                <li class="">
                  <a href="<?= site_url($value->link) ?>">
                    <i class="<?= $value->icon ?>"></i> <span><?= $value->nama ?></span>
                  </a>
                </li>
              <?php endif ?>
            <?php endforeach ?>
