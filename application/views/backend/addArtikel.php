          ...
          <div class="col-md-8">
            ...
            <div class="box box-solid" style="padding: 5px">
              <div class="box-header with-border">
                <h3 class="box-title"><a href="javascript:history.go(-1)" class="text-black form-head"><i class="fa fa-xs fa-angle-left fa-fw"> &nbsp</i>Tambah Artikel</a></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body" style="margin-bottom: 20px">
                <?= form_open_multipart('artikel/addArtikel')?>
                <p>
                  <div class="form-group has-feedback">
                    <label for="">Judul</label>
                    <input type="text" class="form-control" autocomplete="off" name="judul" value="<?= set_value('judul') ?>">
                ...
                <p>
                  ...
                  style="width: 100%; height: 300px; resize: vertical; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= set_value('isi') ?></textarea>
