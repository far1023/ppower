              ...
              <div class="box-body">
                ...
                <div class="form-group has-feedback" style="margin-top: 0.5em">
                  <p style="text-align: center">
                    <img src="<?= base_url('assets/images/avatar/'.$this->session->userdata('avatar'));?>" class="img-circle" style="height: 150px; margin-bottom: 5px" alt="User Image"><br>
                ...
                <div class="form-group has-feedback">
                  ...
                  <?php if ($ttd->title): ?>
                    <p style="text-align: center">
                    <img src="<?= base_url('assets/images/ttd/'.$ttd->title);?>" style="height: 100px; margin-bottom: 5px"><br>
                    <?=anchor( 'profil/index/'.$id.'/_hapus','<span class="label label-danger">Hapus</span>', ['onclick'=>'return confirm(\'Hapus avatar?\')'])?>
                    </p>
                  <?php endif ?>
                  <input id='exampleInputFile' type="file" name="ttd">
                  <p class="help-block">Tanda tangan max 150Kb
                  </p>
                  <small class="text-red"><?= form_error('gambar'); ?></small>
                </div>
                  <?php endif ?>
